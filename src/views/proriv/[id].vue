<template>
  <div class="proriv-program-detail-layout">
    <Sidebar />

    <main class="proriv-program-detail">
      <div class="proriv-program-detail__inner">
        <ParticipantProfile
        ...
        <template v-else>
          ...
          <el-tabs v-model="activeTab" class="proriv-program-detail__tabs">
...
import AddSectionDrawer from '@/components/proriv/AddSectionDrawer.vue'
import EditSectionDrawer from '@/components/proriv/EditSectionDrawer.vue'
import AddParticipantDrawer from '@/components/proriv/AddParticipantDrawer.vue'
import ChangeSectionDrawer from '@/components/proriv/ChangeSectionDrawer.vue'
import EditCommunityProjectDrawer from '@/components/proriv/EditCommunityProjectDrawer.vue'
import AddGalleryPhotoDrawer from '@/components/proriv/AddGalleryPhotoDrawer.vue'
import ProgramHeader from '@/components/proriv/ProgramHeader.vue'
import ParticipantsTable from '@/components/proriv/ParticipantsTable.vue'
import GoalsProgressTable from '@/components/proriv/GoalsProgressTable.vue'
import HabitsTable from '@/components/proriv/HabitsTable.vue'
import CommunityProject from '@/components/proriv/CommunityProject.vue'
import GalleryBlock from '@/components/proriv/GalleryBlock.vue'
import SectionsTable from '@/components/proriv/SectionsTable.vue'
import ParticipantProfile from '@/components/proriv/ParticipantProfile.vue'
...
async function fetchProgramDetail(id) {
  ...
  try {
    ...
    const title =
      programData.name ?? programData.title ?? programData.title_text ?? `Прорыв ${id}`
...
.proriv-program-detail-layout {
  display: flex;
  min-height: 100vh;
  background: var(--ultra-light-grey);
}

.proriv-program-detail {
  flex: 1;
  padding: 30px;
  overflow: auto;
