<template>
  <div class="evolution-community-project">
    <div class="evolution-community-project__head">
      <h3>Общественный проект</h3>
      <el-button
        class="evolution-community-project__edit"
        @click="$emit('edit')"
      >
        Редактировать
      </el-button>
    ...
    <el-table
      class="evolution-community-project__table"
      :data="projectRows"
      border
    >
      <el-table-column
      ...
      >
        <template #default="{ row, $index }">
          <el-input-number
            ...
            class="evolution-community-project__input"
          />
        </template>
      </el-table-column>
      <el-table-column
    ...
    <el-button
      type="primary"
      class="evolution-community-project__save"
      @click="$emit('save')"
    >
      Сохранить
    </el-button>
