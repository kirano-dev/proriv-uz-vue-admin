<template>
  <div class="evolution-participant-profile">
    <ParticipantHeader
...
<script setup>
import ParticipantHeader from '@/components/evolution/ParticipantHeader.vue'
import ParticipantHabitsTable from '@/components/evolution/ParticipantHabitsTable.vue'
import HabitsReportTable from '@/components/evolution/HabitsReportTable.vue'
import GoalsTable from '@/components/evolution/GoalsTable.vue'
import GoalsReportTable from '@/components/evolution/GoalsReportTable.vue'
