...
<script setup>
import ParticipantHeader from '@/components/lp/ParticipantHeader.vue'
import ParticipantHabitsTable from '@/components/lp/ParticipantHabitsTable.vue'
import HabitsReportTable from '@/components/lp/HabitsReportTable.vue'
import GoalsTable from '@/components/lp/GoalsTable.vue'
import GoalsReportTable from '@/components/lp/GoalsReportTable.vue'
